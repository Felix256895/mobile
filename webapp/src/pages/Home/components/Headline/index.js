        ...
        return (
            <div className={styles.headline}>
                <div className={styles.headline__logo}>
                    <img className={styles.headline__logoImg} src={require('@/assets/images/dianping.png')} alt=""/>
                </div>
                <div className={styles.headline__slider}>
                    <Slider  {...settings}>
                        {
                            dataSource.map((item,index)=>{
                                return (
                                    <a href={item.url}
                                     key={index}
                                    className={styles.headline__sliderInner}
                                     >
                                        <div className={styles.headline__sliderTitle}>{item.title}</div>
                                        <div className={styles.headlineImgSwrapper}>
                                            <img className={styles.headline__sliderImg} src={item.pic} alt=""/>
                                        </div>
                                    </a>
                                )
                            })
